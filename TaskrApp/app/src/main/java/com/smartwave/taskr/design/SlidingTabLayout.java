...
package com.smartwave.taskr.design;
...
public class SlidingTabLayout extends HorizontalScrollView {
    ...
    private static final int SELECTED_TEXTVIEW_COLOR = 0xFF1A237E;
    private static final int DEFAULT_TEXTVIEW_COLOR = 0xFFFFFFFF;
